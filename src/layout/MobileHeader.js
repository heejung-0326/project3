...
function MobileHeader({cartCount, setCartCount}){
  ...
  return (
    <header className='mobile_header'>
      <h1>
        <Link to='/'>
          <img src={`${process.env.PUBLIC_URL}/images/mobile_logo.jpg`} alt='메인로고'/>
        </Link>
      </h1>
      {search &&(
      ...
      <div className='mobile_login_box'>
        ...
        <div className='mobile_login_box'>
          ...
          <ul className='mobile_gnb'>
            <li  style={{borderBottom: menutoggle.clothing ? '2px solid #ddd' : 'none', transition:'0.3s'}}>
            ...
            <li style={{borderBottom: menutoggle.shoes ? '2px solid #ddd' : 'none', transition:'0.3s'}}>
            ...
            <li style={{borderBottom: menutoggle.bag ? '2px solid #ddd' : 'none', transition:'0.3s'}}>
            ...
            <li style={{borderBottom: menutoggle.acc ? '2px solid #ddd' : 'none', transition:'0.3s',}}>
            ...
            <li style={{borderBottom: menutoggle.beauty ? '2px solid #ddd' : 'none', transition:'0.3s'}}>
