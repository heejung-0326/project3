...
import { faMessage, faHeart, faChevronDown} from '@fortawesome/free-solid-svg-icons';
...
function NoticeToggle({ title, children }) {
  ...
  const thumbnails = [
    `${process.env.PUBLIC_URL}/images/sub2/sub2_beauty/beauty_pre1.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_beauty/beauty_pre2.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_beauty/beauty_pre3.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_beauty/beauty_pre5.png`,
  ];

  const mainImages = [
    `${process.env.PUBLIC_URL}/images/sub2/sub2_beauty/beauty1.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_beauty/beauty2.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_beauty/beauty3.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_beauty/beauty5.png`,
  ];

  const product = {
    id: 1,
    title: "ANJO",
    desc: "Classic Lotion for Men",
    img: mainImages[0],
    price: 14800
  };
    ...
    return (
      ...
      <div className="info-section">
        ...
        <div className="price-date-wrapper">
          <div className="price">14,800원</div>
        ...
        <ul className="product-info">
          <li>제품명 : 24K GOLD 스킨토너</li>
          <li>용량 : 150ml</li>
          <li>피부타입 : 모든 피부용 (특히 건조/민강성 피부에 적함)</li>
          <li>제형 : 산뚯한 워터 타입</li>
          <li>브랜드 : ANJO</li>
        </ul>
