...
const BootsSub = ({setCartCount})=> {
  ...
  const thumbnails = [
    `${process.env.PUBLIC_URL}/images/sub2/sub2_shoes/shoes_pre1.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_shoes/shoes_pre2.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_shoes/shoes_pre3.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_shoes/shoes_pre5.png`,
  ];

  const mainImages = [
    `${process.env.PUBLIC_URL}/images/sub2/sub2_shoes/shoes1.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_shoes/shoes2.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_shoes/shoes3.png`,
    `${process.env.PUBLIC_URL}/images/sub2/sub2_shoes/shoes5.png`,
  ];
    ...
    <div className="sub2-container">
      ...
      <div className="info-section">
        ...
        <ul className="product-info">
          <li>제품명 : 레드윙 라인맨 8D (남성 워크 부츠)</li>
          <li>사이즈 : 8D (260mm 기준)</li>
          <li>소재 : 천연 가죽 (풀그레인 레더)</li>
          <li>색상 : 다크 브라운</li>
          <li>브랜드 : Red Wing</li>
        </ul>
